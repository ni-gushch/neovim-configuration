return {
	{
		...
		config = function()
			...
			normal_map("<leader>cv", crates.show_versions_popup, { silent = true, desc = "[CRATES] Show version popup" })
			normal_map("<leader>cf", crates.show_features_popup, { silent = true, desc = "[CRATES] Show features popup" })
			normal_map("<leader>cd", crates.show_dependencies_popup, { silent = true, desc = "[CRATES] Show dependencies popup" })
